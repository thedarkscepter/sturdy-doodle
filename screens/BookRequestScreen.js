...
export default class BookRequestScreen extends Component{
  ...
  addRequest = async (bookName,reasonToRequest)=>{
    ...
    var books = await BookSearch.searchbook(bookName,'AIzaSyD3FpqWuARIlPwcfW1Y_ivk10SPFIfqFJE')
...
componentDidMount(){
  var books  = BookSearch.searchbook(bookName,'AIzaSyD3FpqWuARIlPwcfW1Y_ivk10SPFIfqFJE')
  this.getBookRequest()
